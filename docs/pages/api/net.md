...
```lua
function net.request(config: string | NetFetchParams)
```
...
```lua
function net.serve(port: number, handlerOrConfig: NetServeHttpHandler | NetServeConfig)
```
